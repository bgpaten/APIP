          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10 col-md-4">
              <div class="input-group input-group-merge">
                ...
                <input type="text" name="nama" value="{{old('nama')}}" class="form-control @error('nama') is-invalid @enderror" id="basic-icon-default-fullname" placeholder="nama" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2">
            </div>
            @error('nama')
            ...
            <div class="col-sm-10 col-md-4">
              <div class="input-group input-group-merge">
                ...
                <input type="text" name="alamat" value="{{old('alamat')}}" class="form-control @error('alamat') is-invalid @enderror" id="basic-icon-default-fullname" placeholder="Nama Barang" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2">
              </div>
              @error('alamat')
                  <p class="text-danger">{{ $message }}</p>
              @enderror
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10 col-md-4">
              <div class="input-group input-group-merge">
                ...
                <input type="number" name="no_telpon" value="{{old('no_telpon')}}" class="form-control @error('no_telpon') is-invalid @enderror" id="basic-icon-default-fullname" placeholder="Jumlah barang" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2">
              </div>
              @error('no_telpon')
                  <p class="text-danger">{{ $message }}</p>
              @enderror
            ...
            <div class="col-sm-10 col-md-4">
              <div class="input-group input-group-merge">
                ...
                <input type="text" name="kota" value="{{old('kota')}}" class="form-control @error('kota') is-invalid @enderror" class="form-control" id="basic-icon-default-fullname" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2">
              </div>
              @error('kota')
                  <p class="text-danger">{{ $message }}</p>
              @enderror
