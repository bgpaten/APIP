...
@section('button')
    <div class="mb-3 mt-3 ">
        <a href="{{ route('barang') }}"><button class="btn btn-warning"><i
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <form action="{{ route('barang.store') }}" enctype="multipart/form-data" method="post">
                    @csrf
                    <div class="row mb-3">
                      <label class="col-sm-2 col-md-2 col-form-label" for="basic-icon-default-fullname">Nama Barang <span
                              class="text-danger">*</span></label>
                      <div class="col-sm-10 col-md-4">
                          <div class="input-group input-group-merge">
                              <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                      class="fa-solid fa-bag-shopping"></i></span>
                              <select id="nama_barang" class="form-select @error('nama_barang') is-invalid @enderror"
                                  name="nama_barang">
                                  <option hidden>Pilih Nama Barang</option>
                                  @foreach ($barangmasuk as $brg)
                                      <option value="{{ $brg->nama_barang }}" data-kode="{{ $brg->kode_barang }}">{{ $brg->nama_barang }}
                                      </option>
                                  @endforeach
                              </select>
                          </div>
                      ...
                      <label class="col-sm-2 col-md-2 col-form-label" for="basic-icon-default-fullname">Kode <span
                              class="text-danger">*</span></label>
                      <div class="col-sm-10 col-md-4">
                          <div class="input-group input-group-merge">
                              <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                      class="fa-solid fa-paperclip"></i></span>
                              <select id="kode" class="form-select @error('kode') is-invalid @enderror" name="kode">
                  ...
                  <script>
                    ...
                    <div class="row mb-3">
                        ...
                        <label class="col-sm-2 col-md-2 col-form-label" for="basic-icon-default-fullname">Gambar <span
                                class="text-danger">*</span></label>
                        <div class="col-sm-10 col-md-4">
                            <div class="input-group input-group-merge">
                                <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                ...
                                <input type="file" name="gambar" value="{{ old('gambar') }}"
                                    class="form-control @error('gambar') is-invalid @enderror" class="form-control"
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-2 col-md-2 col-form-label" for="basic-icon-default-fullname">Lokasi <span
                                class="text-danger">*</span></label>
                        <div class="col-sm-10 col-md-4">
                            <div class="input-group input-group-merge">
                                <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                        class="fa-solid fa-location-dot"></i></span>
                                <select id="defaultSelect" class="form-select @error('lokasi') is-invalid @enderror"
                        ...
                        <label class="col-sm-2 col-md-2 col-form-label" for="basic-icon-default-fullname">kondisi <span
                                class="text-danger">*</span></label>
                        <div class="col-sm-10 col-md-4">
                            <div class="input-group input-group-merge">
                                <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                        class="fa-solid fa-clipboard"></i></span>
                                <select id="defaultSelect" class="form-select @error('kondisi') is-invalid @enderror"
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-2 col-md-2 form-label" for="basic-icon-default-phone">Kategori <span
                                class="text-danger">*</span></label>
                        <div class="col-sm-10 col-md-4">
                            <div class="input-group input-group-merge">
                                <span id="basic-icon-default-phone2" class="input-group-text"><i
                                        class="fa-solid fa-circle-info"></i></span>
                                <select id="defaultSelect" class="form-select @error('kategori') is-invalid @enderror"
                                    name="kategori">
                        ...
                        <label class="col-sm-2 col-md-2 col-form-label" for="basic-icon-default-fullname">Supplier <span
                                class="text-danger">*</span></label>
                        <div class="col-sm-10 col-md-4">
                            <div class="input-group input-group-merge">
                                <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                        class="fa-solid fa-circle-user"></i></span>
                                <select id="defaultSelect" class="form-select @error('supplier') is-invalid @enderror"
                                    name="supplier">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <textarea id="basic-icon-default-message" name="spesifikasi" class="form-control" placeholder="Spesifikasi"
